...
public enum CropType implements Ingredient {
    ...
    Radish(Seeds.Radish_Seeds,
            ...
            6, true, 0, 90, true, 45,
            new ArrayList<>(List.of(Season.Summer)), false),
    RedCabbage(Seeds.Red_Cabbage_Seeds,
    ...
    Starfruit(Seeds.Starfruit_Seeds,
            ...
            new ArrayList<>(List.of(Season.Summer)), false),
    SummerSpangle(Seeds.Spangle_Seeds,
            new ArrayList<>(Arrays.asList(1, 2, 3, 1)),
            8, true, 0, 90, true, 45,
            new ArrayList<>(List.of(Season.Summer)), false),
    SummerSquash(Seeds.Summer_Squash_Seeds,
            new ArrayList<>(Arrays.asList(1, 1, 1, 2, 1)),
